(function() {
  ...
  let tick = () => {
    ...
    var biomecharnisSection = document.querySelector('.biomecharnis-section')
    ...
    // biomecharnisSection.style.height =
    // // document.body.style.height =
    //   insideFold.scrollers[0].children[0].clientHeight -
    //   center.clientHeight +
    //   window.innerHeight +
  ...
  preloadImages().then(() => {
    ...
    // console.log(biomecharnisSection.offsetParent.id)
    

    biomecharnisSection.classList.remove('loading');
    // INITIALIZE
    ...
    function disableScrolling(){
      var x=biomecharnisSection.scrollX;
      var y=biomecharnisSection.scrollY;
      biomecharnisSection.onscroll=function(){biomecharnisSection.scrollTo(x, y);};
  }
